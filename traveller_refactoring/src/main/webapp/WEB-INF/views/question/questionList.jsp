	...
	<div id="contents" class="contents">
		...
		<div class="js_tabs type1 v-tabs">
			<ul class="tabs">
				...
				<li class="fx-cobrand-htl" style="width: 25%;">
					<a href="questionList.do?question_category=2">교환/환불</a>
				</li> 
				<li class="fx-cobrand-fnd" style="width: 25%;">
					<a href="questionList.do?question_category=3">기타</a>
				</li>
			</ul> 
